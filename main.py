...
#===================Python Variables=======================
menu_category = ["Tablets","Capsules","Drops","Injections","Liquid","Energy Drinks","Inhalers"]

menu_category_dict = {"Tablets":"1 Tablets.txt","Capsules":"2 Capsules.txt",
                "Injections":"3 Injections.txt","Inhalers":"4 Inhalers.txt",
                "Liquid":"5 Liquid.txt","Drops":"6 Drops.txt",
                "Energy Drinks":"7 Energy Drinks.txt"}
...
root.title("Welcome to Grand Health")
...
title_frame = Frame(root, bd=8, bg="IndianRed3", relief=GROOVE)
title_frame.pack(side=TOP, fill="x")

title_label = Label(title_frame, text="Grand Health", 
                    font=("times new roman", 20, "bold"),bg = "IndianRed3", fg="black", pady=5)
title_label.pack()

#==============Customer=============
customer_frame = LabelFrame(root,text="Customer Details",font=("times new roman", 15, "bold"),
                            bd=8, bg="azure3", relief=GROOVE)
customer_frame.pack(side=TOP, fill="x")

customer_name_label = Label(customer_frame, text="Name", 
                    font=("arial", 15, "bold"),bg = "azure3", fg="black")
...
#===============Menu===============
menu_frame = Frame(root,bd=8, bg="steelblue", relief=GROOVE)
menu_frame.place(x=0,y=125,height=585,width=680)

menu_label = Label(menu_frame, text="Menu", 
                    font=("times new roman", 20, "bold"),bg = "steelblue", fg="black", pady=0)
menu_label.pack(side=TOP,fill="x")

menu_category_frame = Frame(menu_frame,bg="steelblue",pady=10)
menu_category_frame.pack(fill="x")

combo_lable = Label(menu_category_frame,text="Select Type", 
                    font=("arial", 12, "bold"),bg = "steelblue", fg="black")
...
#===============Item Frame=============
item_frame = Frame(root,bd=8, bg="steelblue", relief=GROOVE)
item_frame.place(x=680,y=125,height=230,width=680)

item_title_label = Label(item_frame, text="Item", 
                    font=("times new roman", 20, "bold"),bg = "steelblue", fg="black")
item_title_label.pack(side=TOP,fill="x")

item_frame2 = Frame(item_frame, bg="steelblue")
...
item_frame3 = Frame(item_frame, bg="steelblue")
...
#==============Order Frame=====================
order_frame = Frame(root,bd=8, bg="steelblue", relief=GROOVE)
